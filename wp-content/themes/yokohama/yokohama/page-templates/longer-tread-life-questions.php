<?php
/**
 * Template Name: Longer Tread Life - Questions
 *
 * @package WordPress
 */
									...
									<div class="questions-wrap">
										<ul class="d-flex flex-wrap">
											<?php foreach( $question['answers'] as $answer_id => $answer ) : ?>
												<li>
													<div class="question-box exclude-quiz" data-field_name="ltl_question" data-post_id="<?php echo get_the_ID() ?>" data-id="<?php echo $key; ?>">
