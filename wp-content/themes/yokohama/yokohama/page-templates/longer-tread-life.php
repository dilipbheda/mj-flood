<?php
/**
 * Template Name: Longer Tread Life
 *
 * @package WordPress
 */
			...
			<div class="container">
				<div class="title-section text-white">
					...
					<div class="cta-wrap continue-btn" hidden>
						<a href="<?php echo yokohama_get_page_by_template( 'page-templates/longer-tread-life-questions.php' ); ?>" class="cta-btn cta-sm"><span><?php _e( 'continue', 'yokohama' ); ?><img src="<?php echo TEMPLATEURL; ?>/assets/images/right-arrow-white.svg" class="cta-arrow svg" alt=""></span></a>
					</div>
				</div>
